...
- 금지 selector 사용
  ...
  - `main#sample-page` 단독 selector
  - `main#alternate-sample-page` 단독 selector
...
```js
{ text: 'Product A', id: '4_1', ngClick: "selectMenu('product-a')", cssPath: "nav.primary li.product-a > a" }
```
